package seoulnightmarket.seoulnightmarket.View;
...
public class ObservableGridView extends GridView implements Scrollable {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = seoulnightmarket.seoulnightmarket.View.ObservableGridView.this.getMeasuredWidth()
                - seoulnightmarket.seoulnightmarket.View.ObservableGridView.this.getPaddingLeft()
                - seoulnightmarket.seoulnightmarket.View.ObservableGridView.this.getPaddingRight();
